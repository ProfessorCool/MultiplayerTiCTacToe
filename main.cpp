...
int main()
{
	int gamestate = 1; //1 to play, 0 to exit (might end up just being always true and unnecessary
	while (gamestate)
	{
		std::cout << "Enter 0 to play singleplayer, 1 for multiplayer, and 2 to exit.\n";
		int input;
		std::cin >> input;
		...
		if (input == 0)
		{
			...
			while (input)
			{
				...
				board.display();
				std::cout << "The winner is " << board.winnerIs() << "\n\n";
				std::cout << "Play again? Enter 1 for yes, 0 for no\n";
